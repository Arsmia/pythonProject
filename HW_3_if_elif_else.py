...
usd_rub_rate = 71.88
print("usd_rub_item = ", usd_rub_rate)
...
if mult_int > comp_item:
    print("Переменная mutl_int больше ", comp_item)
...
#     print("Переменная div_item меньше ", comp_item)
...
if currency_converter:
    print("Выполнить следующие шаги задания ")
else:
